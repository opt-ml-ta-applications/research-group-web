...
1. Install the dependencies. You will need [Ruby][]('sudo apt install ruby ruby*dev gcc g++'), [Python][], [bibble][] (from github to install: `git clone https://github.com/sampsyo/bibble.git; cd bibble; pip install -e .`), and  [Jekyll][] (`gem install jekyll`).
...
'sudo jekyll serve --host 0.0.0.0 --port 80 --detach'
